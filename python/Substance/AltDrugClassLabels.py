...
class AltDrugClassLabels(metaclass=Singleton):
    ...
    dict_alt_2_main_label: Dict[str, List[str]] = {}  # map an alternative label to a list of main labels
    dict_main_2_alt_label: Dict[str, List[str]] = {}  # map a main label to a list of alternative labels
